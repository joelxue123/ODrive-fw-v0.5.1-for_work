...
LDFLAGS += '-mthumb -mcpu=cortex-m4 -specs=nosys.specs -u _printf_float   -u _scanf_float -specs=nano.specs  -mfpu=fpv4-sp-d16 -mfloat-abi=hard -Wl,--cref -Wl,--gc-sections' --   
